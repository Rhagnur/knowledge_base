...
<g:applyLayout name="subPage">
    <head>
        <title><g:message code="doctorate.all.title"/></title>
    </head>
    <content tag="main">
        <style type="text/css">
        ...
        <article class="main">
            <section>
                <g:if test="${all}">
                    ...
                    <nav class="pagerUss">
                        <g:paginate controller="doctorates" action="all" max="10" offset="0" total="${count}" prev="&lt;" next="&gt;" maxsteps="9" omitFirst="true" omitLast="true"/>
                    </nav>
                </g:if>
                <g:else>
