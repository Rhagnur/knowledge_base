...
/*    def flushOMatic(AbstractSession s)  {
    ...
    def initTestModell() {
        ...
        for (int i = 0; i < numberOfDocs; i++) {
            Document.withSession { session ->
                ...
                if (magicNumber == 0 || magicNumber == 1 || magicNumber == 2) {
                    ...
                    doc = new Article(docTitle: "Testartikel${i}", locked: false, viewCount: random.nextInt(3000), tags: ["Test"], createDate: new Date(), docContent: "<h2>Der Schmerz?</h2>\n" +
                            "<img src=\"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Image_manquante_2.svg/320px-Image_manquante_2.svg.png\"/ align=\"left\" style=\"margin-right:2em; margin-bottom:1em;\">\n" +
                            "<p>\n" +
        ...
        def theme = new Category(name: 'theme')
                .addToSubCats(new Subcategory(name: 'eFormulare'))
                .addToSubCats(new Subcategory(name: 'groupware'))
                .addToSubCats(new Subcategory(name: 'account'))
                .addToSubCats(new Subcategory(name: 'kopieren_drucken'))
                .addToSubCats(new Subcategory(name: 'email'))
                .addToSubCats(new Subcategory(name: 'speicherplatz'))
                .addToSubCats(new Subcategory(name: 'vpn'))
                .addToSubCats(new Subcategory(name: 'web'))
                .addToSubCats(new Subcategory(name: 'telefonie'))
                .addToSubCats(new Subcategory(name: 'lan'))
                .addToSubCats(new Subcategory(name: 'wlan'))
                .addToSubCats(new Subcategory(name: 'cm'))
                .save(flush: true)
        ...
        def os = new Category(name: 'os')
                .addToSubCats(new Subcategory(name: 'symbian'))
                .addToSubCats(new Subcategory(name: 'kindle_touch'))
                .addToSubCats(new Subcategory(name: 'windows')
                    .addToSubCats(new Subcategory(name: 'win_xp'))
                    .addToSubCats(new Subcategory(name: 'win_vista'))
                    .addToSubCats(new Subcategory(name: 'win_7'))
                    .addToSubCats(new Subcategory(name: 'win_8'))
                    .addToSubCats(new Subcategory(name: 'win_10'))
                    .addToSubCats(new Subcategory(name: 'win_phone'))
                )
                .addToSubCats(new Subcategory(name: 'linux'))
                .addToSubCats(new Subcategory(name: 'ubuntu'))
                .addToSubCats(new Subcategory(name: 'android')
                    .addToSubCats(new Subcategory(name: 'an_5_1'))
                )
                .addToSubCats(new Subcategory(name: 'ios')
                    .addToSubCats(new Subcategory(name: 'ios_6'))
                    .addToSubCats(new Subcategory(name: 'ios_7'))
                    .addToSubCats(new Subcategory(name: 'ios_8'))
                )
                .addToSubCats(new Subcategory(name: 'mac')
                    .addToSubCats(new Subcategory(name: 'osx_10_4'))
                    .addToSubCats(new Subcategory(name: 'osx_10_5'))
                    .addToSubCats(new Subcategory(name: 'osx_10_6'))
                    .addToSubCats(new Subcategory(name: 'osx_10_7'))
                    .addToSubCats(new Subcategory(name: 'osx_10_8'))
                    .addToSubCats(new Subcategory(name: 'osx_10_9'))
                    .addToSubCats(new Subcategory(name: 'osx_10_10'))
                    .addToSubCats(new Subcategory(name: 'osx_10_11'))
                )
                .save(flush: true)
        myMains.put('os', os)
